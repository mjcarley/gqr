...
The GQR library computes Gaussian and Gaussian-\/type quadrature rules including some which handle singular integrands. A simple example of its use to integrate a function is\+: {\texttt{ example.\+c}}.
...
Referenced by \textbf{ gqr\+\_\+rule\+\_\+realloc()}.
...
References \textbf{ gqr\+\_\+rule\+\_\+name()}.
